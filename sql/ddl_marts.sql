...
DROP VIEW IF EXISTS `dwh-midterm-123456.retail_marts.dim_customer`;
...
DROP VIEW IF EXISTS `dwh-midterm-123456.retail_marts.dim_product`;
...
DROP VIEW IF EXISTS `dwh-midterm-123456.retail_marts.fact_sales`;
